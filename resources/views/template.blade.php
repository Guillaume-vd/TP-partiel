            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{url('/categorie')}}">Les dessinateurs</a>
                        <a class="dropdown-item" href="{{url('/ajoutFilm')}}">Les scénaristes</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="" id="navbardrop" data-toggle="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{url('/ajoutFilm')}}">Ajouter un manga</a>
                        <a class="dropdown-item" href="{{url('/ajoutCategorie')}}">Ajouter un dessinateur</a>
                    </div>
                </li>
                <li class="nav-item">
